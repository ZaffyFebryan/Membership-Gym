...
<body class="galeri">
    ...
    <section class="hero" id="home">
        <div class="galeria" style="margin-bottom: 4rem;">
            <div>
                <img src="../public/img/alat1.jpg">
            </div>
            <div>
                <img src="../public/img/alat2.jpg">
            </div>
            <div>
                <img src="../public/img/alat3.jpg">
            </div> 
            <div>
                <img src="../public/img/alat4.jpg">
            </div>
            <div>
                <img src="../public/img/alat5.jpg">
            </div>
            <div>
                <img src="../public/img/alat6.jpg">
            </div>
        </div>
    </section>   
